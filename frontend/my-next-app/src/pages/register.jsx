"use client"
import { Box, TextField, Button, Typography, Paper, Link as MuiLink, InputLabel } from "@mui/material"
      ...
      >
        <form onSubmit={handleRegister}>
          ...
          {[
            ...
            { name: "confirmPassword", label: "Potvrdi lozinku", type: "password" },
          ].map((field) => (
            <TextField
              key={field.name}
              label={field.label}
          ...
          <FormControl fullWidth sx={{ mb: 4 }}>
            ...
            >
              <MenuItem value="user" sx={{ color: "#fff", background: "#2a2a2a" }}>
                Tražim posao
              </MenuItem>
              <MenuItem value="hr" sx={{ color: "#fff", background: "#2a2a2a" }}>
                Objavljujem poslove
              </MenuItem>
            </Select>
          </FormControl>
